			...
			<div class="store-list-left-block col-sm-4 padding_top_20">
			    <div style="position:relative; z-index:999999999;">
    				...
    				<div class="alphabet-dd show_phone" >
    				    <v-select v-model="selectedStore" :options="filteredStores" searchable=false id="mobile_alpha_list" label="name" placeholder="Select a Store" @transition="slide"></v-select>
    			    </div>
			    </div>
